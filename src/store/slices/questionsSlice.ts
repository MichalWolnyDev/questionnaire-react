...
export interface QuestionState {
  totalChecked: number,
    dictionary: Array<{title: string, checkedCount:number, groupId: number, questions: Array<{id: number, question: string, checked: boolean}>}>
}
...
const initialState: QuestionState = {
          ...
          questions: [
            {
                id: 31,
              question:
                "Przygotowana indywidualna oferta.",
                checked: false
            },
            {
                id: 32,
  ...
  export const { changeChecked } = questionSlice.actions
